...
insert into subject (id, name) values (1, 'Організація комп`ютерних мереж');
insert into subject (id, name) values (2, 'Комп`ютерне моделювання та оптимізація');
insert into subject (id, name) values (3, 'Методології розробки інтелектуальних комп`ютерних програм');
insert into subject (id, name) values (4, 'Іноземна мова професійного спрямування');
insert into subject (id, name) values (5, 'Архітектура програмного забезпечення-3');
...
insert into subject_speciality (id, test_type, group_id, subject_id) values (1, 'екзамен', 1, 1);
insert into subject_speciality (id, test_type, group_id, subject_id) values (2, 'екзамен', 2, 1);
insert into subject_speciality (id, test_type, group_id, subject_id) values (3, 'екзамен', 1, 2);
insert into subject_speciality (id, test_type, group_id, subject_id) values (4, 'екзамен', 2, 2);
insert into subject_speciality (id, test_type, group_id, subject_id) values (5, 'залік', 1, 3);
insert into subject_speciality (id, test_type, group_id, subject_id) values (6, 'залік', 2, 3);
insert into subject_speciality (id, test_type, group_id, subject_id) values (7, 'залік', 1, 4);
insert into subject_speciality (id, test_type, group_id, subject_id) values (8, 'залік', 2, 4);

insert into subject_teacher (id, subject_id, teacher_id) values (1, 1, 4);
insert into subject_teacher (id, subject_id, teacher_id) values (2, 2, 2);
insert into subject_teacher (id, subject_id, teacher_id) values (3, 3, 5);
insert into subject_teacher (id, subject_id, teacher_id) values (4, 4, 1);

insert into mark (id, value, student_id, subject_speciality_id) values (1, 96, 3, 4);
insert into mark (id, value, student_id, subject_speciality_id) values (2, 89, 2, 2);
insert into mark (id, value, student_id, subject_speciality_id) values (3, 87, 2, 3);
insert into mark (id, value, student_id, subject_speciality_id) values (4, 56, 4, 2);
insert into mark (id, value, student_id, subject_speciality_id) values (5, 55, 5, 1);
insert into mark (id, value, student_id, subject_speciality_id) values (6, 88, 2, 2);
insert into mark (id, value, student_id, subject_speciality_id) values (7, 90, 5, 4);
insert into mark (id, value, student_id, subject_speciality_id) values (8, 94, 4, 2);
insert into mark (id, value, student_id, subject_speciality_id) values (9, 97, 6, 4);
insert into mark (id, value, student_id, subject_speciality_id) values (10, 87, 2, 6);
insert into mark (id, value, student_id, subject_speciality_id) values (11, 89, 4, 1);
insert into mark (id, value, student_id, subject_speciality_id) values (12, 94, 4, 6);
insert into mark (id, value, student_id, subject_speciality_id) values (13, 97, 7, 4);
insert into mark (id, value, student_id, subject_speciality_id) values (14, 95, 3, 2);
insert into mark (id, value, student_id, subject_speciality_id) values (15, 90, 7, 5);
insert into mark (id, value, student_id, subject_speciality_id) values (16, 98, 3, 6);
insert into mark (id, value, student_id, subject_speciality_id) values (17, 85, 5, 8);
insert into mark (id, value, student_id, subject_speciality_id) values (18, 86, 2, 1);
insert into mark (id, value, student_id, subject_speciality_id) values (19, 93, 5, 3);
insert into mark (id, value, student_id, subject_speciality_id) values (20, 88, 4, 7);